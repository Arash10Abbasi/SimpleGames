// Task Description: The following code simulates 100 games and prints how many times you won! Your task is to log the steps, so it will show what is happening during each simulation.
